...
#ifndef ZTD_ENCODING_TABLES_KOI8_U_TABLES_HPP
#define ZTD_ENCODING_TABLES_KOI8_U_TABLES_HPP
...
namespace ztd { namespace et {
	...
	inline constexpr ::std::optional<::std::uint_least32_t> koi8_u_index_to_code_point(
		...
		auto __first                        = ::ztd::ranges::cbegin(ztd_et_koi8_u_index_code_point_map);
		auto __last                         = ::ztd::ranges::cend(ztd_et_koi8_u_index_code_point_map);
		auto __it_and_last
	...
	inline constexpr ::std::optional<::std::size_t> koi8_u_code_point_to_index(
