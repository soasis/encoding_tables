...
#ifndef ZTD_ENCODING_TABLES_ATASCII_TABLES_HPP
#define ZTD_ENCODING_TABLES_ATASCII_TABLES_HPP
...
namespace ztd { namespace et {
	...
	inline constexpr ::std::optional<::std::size_t> atascii_code_point_to_index(
