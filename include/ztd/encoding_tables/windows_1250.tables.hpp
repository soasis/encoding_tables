...
#ifndef ZTD_ENCODING_TABLES_WINDOWS_1250_TABLES_HPP
#define ZTD_ENCODING_TABLES_WINDOWS_1250_TABLES_HPP
...
namespace ztd { namespace et {
	...
	inline constexpr ::std::optional<::std::uint_least32_t> windows_1250_index_to_code_point(
		...
		if (__lookup_index == 0x18) {
			// undefined character: answer is NO.
			return ::std::nullopt;
		}
		// standard lookup table
		auto __first = ::ztd::ranges::cbegin(ztd_et_windows_1250_index_code_point_map);
		auto __last  = ::ztd::ranges::cend(ztd_et_windows_1250_index_code_point_map);
		auto __it_and_last
	...
	inline constexpr ::std::optional<::std::size_t> windows_1250_code_point_to_index(
