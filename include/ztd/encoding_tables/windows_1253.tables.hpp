...
#ifndef ZTD_ENCODING_TABLES_WINDOWS_1253_TABLES_HPP
#define ZTD_ENCODING_TABLES_WINDOWS_1253_TABLES_HPP
...
namespace ztd { namespace et {
	...
	inline constexpr ::std::optional<::std::uint_least32_t> windows_1253_index_to_code_point(
		::std::size_t __lookup_index_pointer) noexcept {
		return ::ztd::et::single_byte_high_index_to_code_point(
			ztd_et_windows_1253_index_code_point_map, __lookup_index_pointer);
	}

	inline constexpr ::std::optional<::std::size_t> windows_1253_code_point_to_index(
		::std::uint_least32_t __lookup_code_point) noexcept {
		return ::ztd::et::single_byte_high_code_point_to_index(
			ztd_et_windows_1253_index_code_point_map, __lookup_code_point);
	}
