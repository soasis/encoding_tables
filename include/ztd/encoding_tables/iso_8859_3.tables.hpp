...
#ifndef ZTD_ENCODING_TABLES_ISO_8859_3_TABLES_HPP
#define ZTD_ENCODING_TABLES_ISO_8859_3_TABLES_HPP
...
namespace ztd { namespace et {
	...
	inline constexpr ::std::optional<::std::uint_least32_t> iso_8859_3_index_to_code_point(
		...
		auto __first                        = ::ztd::ranges::cbegin(ztd_et_iso_8859_3_index_code_point_map);
		auto __last                         = ::ztd::ranges::cend(ztd_et_iso_8859_3_index_code_point_map);
		auto __it_and_last
	...
	inline constexpr ::std::optional<::std::size_t> iso_8859_3_code_point_to_index(
