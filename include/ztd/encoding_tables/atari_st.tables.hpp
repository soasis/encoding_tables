...
#ifndef ZTD_ENCODING_TABLES_ATARI_ST_TABLES_HPP
#define ZTD_ENCODING_TABLES_ATARI_ST_TABLES_HPP
...
namespace ztd { namespace et {
	...
	inline constexpr ::std::optional<::std::uint_least32_t> atari_st_index_to_code_point(
