...
#ifndef ZTD_ENCODING_TABLES_PETSCII_TABLES_HPP
#define ZTD_ENCODING_TABLES_PETSCII_TABLES_HPP
...
namespace ztd { namespace et {
	...
	inline constexpr ::std::optional<::std::uint_least32_t> petscii_unshifted_index_to_code_point(
		...
		auto __first                        = ::ztd::ranges::cbegin(ztd_et_petscii_unshifted_index_code_point_map);
		auto __last                         = ::ztd::ranges::cend(ztd_et_petscii_unshifted_index_code_point_map);
		auto __it_and_last
	...
	inline constexpr ::std::optional<::std::size_t> petscii_unshifted_code_point_to_index(
	...
	inline constexpr ::std::optional<::std::uint_least32_t> petscii_shifted_index_to_code_point(
		::std::size_t __lookup_index_pointer) noexcept {
		const ztd_et_index16 __lookup_index = static_cast<ztd_et_index16>(__lookup_index_pointer);
		auto __first                        = ::ztd::ranges::cbegin(ztd_et_petscii_shifted_index_code_point_map);
		auto __last                         = ::ztd::ranges::cend(ztd_et_petscii_shifted_index_code_point_map);
		auto __it_and_last
			= ::ztd::ranges::lower_bound(__first, __last, __lookup_index, &::ztd::et::less_than_index16_target);
		if (__it_and_last.current == __it_and_last.last) {
			return ::std::nullopt;
	...
	inline constexpr ::std::optional<::std::size_t> petscii_shifted_code_point_to_index(
		::std::uint_least32_t __lookup_code_point) noexcept {
		auto __predicate = [&__lookup_code_point](const ztd_et_index16_code_point_t& __value) {
			return __lookup_code_point == __value[1];
		};
